...
class CategoryController extends Controller
{
    ...
    protected function validator(array $data)
    {
        ...
        return Validator::make(
            ...
            [
                "name.unique" => translate("the name is required"),
    ...
    public function store(Request $request)
    {
        ...
        if ($validate->fails()) {
            flash(translate('Please Enter Unique Name'))->error();
            return back();
        }
        ...
        if ($request->has("attributes")) {
            foreach ($request["attributes"] as $attr_id) {
                $attributeCategory = new AttributeCategory();
                $attributeCategory->attribute_id = $attr_id;
