...
class WalletController extends Controller
{
    ...
    public function recharge(Request $request)
    {
        ...
        if ($request->payment_option == 'paypal') {
            ...
            return $iyzico->pay();
        } else if ($request->payment_option == 'paytab') {

            $paytab = new PayTabController();
            return $paytab->pay();
        ...
        }else if ($request->payment_option == 'fekrapay') {

            $fekra_pay = new FekraPayController();
