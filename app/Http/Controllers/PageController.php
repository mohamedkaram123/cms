...
class PageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Page::where('slug', preg_replace('/[^أ-يA-Za-z0-9\-]/', '', str_replace(' ', '-', $request->slug)))->first() == null) {
            $page->slug             = preg_replace('/[^أ-يA-Za-z0-9\-]/', '', str_replace(' ', '-', $request->slug));
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($page != null) {
            ...
            } else if ($page->type == 'back-to-school') {
                return view('backend.website_settings.pages.return_to_school_edit', compact('page', 'lang'));
            } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if (Page::where('id', '!=', $id)->where('slug', preg_replace('/[^أ-يA-Za-z0-9\-]/', '', str_replace(' ', '-', $request->slug)))->first() == null) {
    ...
    public function show_custom_login()
    {
        return view("backend.website_settings.pages.custom_user_login");
    }

    public function show_custom_register()
    {
        return view("backend.website_settings.pages.custom_user_register");
    }
}
