...
export default function TemporaryDrawer({trans,fetchAPIData,endDataResponse,endData,handleDataDrawer}) {
 ...
 useEffect(() => {
    ...
    const  handleClick = (data)=>{
        ...
        // //       "_token": csrf_token
        // //   };
        //   axios.post(Urls.static_url + "NewerOrders/search_orders",data)
        //   .then(res=>{
        ...
        //       clickbtnSaveData(res.data.orders)
        //               setloadingBtn(false)
        //       setToggleDrawerBottom(false)
  ...
  const list = (anchor) => (
    ...
    <div  className="card"  style={{padding:40,paddingInline:"20%"}}>
            ...
            <div className="form-group">
                                        ...
                                        <input value={DataSearchSellersTable.name} type="text" onChange={e => {
            ...
            <div className="form-group">
                                        ...
                                        <input value={DataSearchSellersTable.email} type="text" onChange={e => {
            ...
            <div className="form-group">
                                        ...
                                        <input value={DataSearchSellersTable.phone} type="number" onChange={e => {
                                                     setDataSearchSellersTable((prevState) => ({
                                                                ...prevState,
         ...
         <div className="col-12 col-md-3">
            <div className="form-group">
                                        ...
                                        <input value={DataSearchSellersTable.balance} type="number" onChange={e => {
                                                     setDataSearchSellersTable((prevState) => ({
                                                                ...prevState,
