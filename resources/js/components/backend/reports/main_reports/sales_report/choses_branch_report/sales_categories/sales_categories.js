...
import NumberCategoriesSales from './number_categories_sales';

export default function SalesCategories({ state,startDate,endDate,loadDataSalesCategories,data_is_reached,data_is_start_load}) {
    ...
    useEffect(() => {
      if (!mounted.current) {
        ...
        mounted.current = true;
          ...
          if (loadDataSalesCategories == true) {
...
data_is_start_load("sales")
        ...
        axios.post(Urls.static_url+"main/report/all_categories_products_sale",data)
            .then(res => {
    ...
    if (isLoading) {
       ...
       <div className="card" style={{ boxShadow: "5px 5px 5px #eee" }} >
                    ...
                    <div style={{direction:"ltr"}} className="card-body">
                                ...
                                <NumberCategoriesSales dataChart={categories}  />
