...
export default function BodyReminderBasket({trans,objectGetData,getData}) {
    ...
    return (
        <div>
                          ...
                          <div className="row">
                                 ...
                                 {discounreminderData.discountBasket?(                                 <div className="row">
                                     <div className="col-12">
                                    <div className="form-group">
                                            <div className="input-group">
                                            <div className="input-group-prepend">
                    ...
                    <span>{trans["discount expiry date"]} : </span><span className="badge badge-primary" style={{ width: "auto" }}>{"{var_date}"}</span>
                                 ...
                                 <div style={{marginBlock:20}} className="row">
                                    ...
                                    <div className="form-group">
                                           ...
                                           <select  value={discounreminderData.date_send_type} onChange={(e)=>{
                                               setdiscounreminderData((prevState) => ({
                                                                        ...prevState,
                                                                        date_send_type: e.target.value,
                                                                    }));

                                           }} className="form-control" >
                                               <option value="now">{trans["send now"]}</option>
                                               <option value="time">{trans["specific time"]}</option>
                                           </select>
                                           </div>
                                            </div>
                                    </div>
                                 ...
                                 {
                                     discounreminderData.date_send_type == "time"?(
                                            <div style={{marginBlock:20}} className="row">
                                     <div className="col-12">
                                    <div className="form-group">
                                            <div className="input-group">
                                           ...
                                           <TextField
                                                    id="datetime-local"
                                                    label={trans["date send offer"]}
                                                    type="datetime-local"
                                                    defaultValue={new Date(new Date().setDate((new Date()).getDate()+2)).toISOString().toString().slice(0,16)}
                                                    style={{width:"80%"}}
                                                    onChange={e=>{
                                                          setdiscounreminderData((prevState) => ({
                                                                        ...prevState,
                                                                        date_send_offer: convertDate(e.target.value),
                                                                    }));
                                                    }}
                                                    // className={classes.textField}
                                                    // className="form-control"
