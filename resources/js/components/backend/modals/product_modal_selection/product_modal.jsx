...
getDataProducts = (objProduct,search = null)=>{
    ...
    objProduct["pagination"] =search != null?0:this.increment;

    this.setState({
        productData:objProduct
    })
    axios.post(Urls.static_url + "products/getProductsData", objProduct)
     .then(res=>{
...
handleAddDataProduct = (productData)=>{
    ...
    if (this.props.selected_item == 1) {
          this.setState({
              productDataArr: [productData],
              selectedItemProduct:productData.id
    })
    } else {
            this.setState({
      ...
      this.setState({
        productDataArr:[]
         ...
         handleScroll = (e) => {
          ...
          if (bottom) {
              this.getDataProducts(this.state.productData);
          } else {
...
<Modal.Header closeButton>
            ...
            <HeaderModalProduct
                ...
                <div onScroll={this.handleScroll} style={{maxHeight:400,overflow:'auto'}}>
                  ...
                  <BodyModalProduct selectedItemProduct={this.state.selectedItemProduct} selected_item={this.props.selected_item} products={this.props.products}  handleAddDataProduct={this.handleAddDataProduct} handleremoveDataProduct={this.handleremoveDataProduct}  trans={this.state.trans}  product={item} />
