...
export default class SaudiTab extends Component {
    ...
    constructor(){
       ...
       langs:{
            ...
            setting:{
                "PAYTAB_PROFILE_ID_saudi":"",
                "PAYTAB_SERVER_KEY_saudi":"",
                "paytab_sandbox_saudi":"",
                "pay_tab_defualt":"",
  ...
  this.get_setting_data(this.state.setting)
    ...
    save_date = ()=>{
      ...
      let csrf_token =   document.querySelector('meta[name="csrf-token"]').getAttribute('content');
        ...
        let data = {
       PAYTAB_PROFILE_ID: this.state.PAYTAB_PROFILE_ID == ""?this.state.setting["PAYTAB_PROFILE_ID_saudi"]:this.state.PAYTAB_PROFILE_ID,
            PAYTAB_SERVER_KEY:this.state.PAYTAB_SERVER_KEY == ""?this.state.setting["PAYTAB_SERVER_KEY_saudi"]:this.state.PAYTAB_SERVER_KEY,

            paytab_sandbox:this.state.paytab_sandbox_on_and_off == true?1:0,
                        pay_tab_defualt: this.state.paytab_defualt == true ? "sa" : "eg",
        ...
        axios.post("saveData/setting/paytabs/saudi",data)
        .then(res=>{
    ...
    render(){
        ...
        if(this.state.loading == true){
            ...
            return ( <div>
                ...
                defaultValue = { this.state.setting["PAYTAB_PROFILE_ID_saudi"] }
                ...
                type="text"
                defaultValue={ this.state.setting["PAYTAB_SERVER_KEY_saudi"] }
                className="form-control" />
                </div>
                </div>
                ...
                defaultChecked = { parseInt(this.state.setting["paytab_sandbox_saudi"]) == 1 ? true : false }
                name="paytab_sandbox"
                type="checkbox" />
                ...
                defaultChecked = { this.state.setting["pay_tab_defualt"] == "sa" ? true : false }
                name="paytab_sandbox"
                type="checkbox" />
                <span className="slider round" > </span>
                </label>
