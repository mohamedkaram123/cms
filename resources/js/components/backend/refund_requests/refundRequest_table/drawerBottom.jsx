      ...
      >
          ...
          <div className="card" style={{ padding: 40, paddingInline: "20%" }}>
            ...
            <div className="form-group">
                                        ...
                                        <input value={DataSearchOrdersTable.user_name} type="text" onChange={e => {
                                             ...
                                             }}  placeholder={trans["user name"]} className="form-control" />
                                           </div>
                                        </div>
            ...
            <div className="form-group">
                                        ...
                                        <input value={DataSearchOrdersTable.order_code} type="text" onChange={e => {
                                         ...
                                         <div className="col-12 col-md-3">
                                 <div className="form-group">
                                            <label >{trans["Refun Request Status"]} </label>
                                            <div className="input-group">
                                            <div className="input-group-prepend">
                                            <span className="input-group-text" style={{background:"#fff"}}>
                                            <i className="las la-truck"></i>
                                                 ...
                                                 <select value={DataSearchOrdersTable.status} onChange={e => {
                                                            setDataSearchOrdersTable((prevState) => ({
                                                                ...prevState,
