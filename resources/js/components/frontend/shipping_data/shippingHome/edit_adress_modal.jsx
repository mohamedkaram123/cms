...
export default function EditAddressModal({handleClose,show,handleSaveChange,id}) {
    ...
    const adress = () => {
        axios.get(Urls.url + `shipping/edit/address/${id}`)
            .then(res => {
        ...
        "adress_type":res.data.address.adress_type
                } );
    ...
    const handleSaveChangeAddress = () => {
        ...
        // }
            if (dataSubmit) {
                ...
                axios.post(Urls.url + "shipping/address/update",DataAddresses)
                    .then(res => {
...
{isLoading?<LoadingInline />:
                ...
                <Modal.Title>{trans["Edit Address"]}</Modal.Title>
