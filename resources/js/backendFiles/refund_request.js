...
import RefundRequestTable from '../components/backend/refund_requests/refundRequest_table/refundRequest_table';
...
if (document.getElementById('notify_wrapper')) {
    ...
    if (document.getElementById('Notififcation_items')) {
        ...
        if (document.getElementById('refund_request')) {
            ReactDOM.render( < RefundRequestTable /> , document.getElementById('refund_request'));
        }
