...
import OrdersLogTable from '../components/backend/orders_log/ordersLog_table/ordersLog_table';
...
if (document.getElementById('notify_wrapper')) {
    ...
    if (document.getElementById('Notififcation_items')) {
        ...
        if (document.getElementById('orders_log')) {
            ReactDOM.render( < OrdersLogTable
                />, document.getElementById('orders_log'));
            }
