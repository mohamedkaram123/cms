...
@section('content')
                        ...
                        <div class="sticky-top z-3 row gutters-10">
                            ...
                            <div class="col-12 col-md-auto w-md-80px order-2 order-md-1 mt-3 mt-md-0">
                                <div class="aiz-carousel product-gallery-thumb" data-items='5'
                                    ...
                                    @foreach ($photos as $key => $photo)
                                        <div class="carousel-box c-pointer border p-1 rounded">
                                            <img class="lazyload mw-100 size-50px mx-auto" style="width: 80%;height: 80%;"
                                                src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                data-src="{{ uploaded_asset($photo) }}"
                                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                        </div>
                                ...
                                <div class="d-table-cell">
                                    ...
                                    <div class="d-flex flex-md-row flex-column">
                                        ...
                                        <button tabindex="1" type="button" class="btn-login btn-6"
                                            onclick=" show_share_modal()">
                                            <div class="span-login">
                                                <i style="margin-inline: 10px;" class="la la-share la-2x opacity-80"></i>
                                                {{ translate('Share') }}
                                        ...
                                        <button tabindex="1" type="button" class="btn-login btn-6"
                                            ...
                                            <div class="span-login">
                                                <i style="margin-inline: 10px" class="la la-heart-o la-2x opacity-80"></i>
                                        ...
                                        <button tabindex="1" type="button" class="btn-login btn-6"
                                            ...
                                            <div class="span-login">
                                                <i style="margin-inline: 10px" class="la la-refresh la-2x opacity-80"></i>
    ...
    \App\Review::where('user_id', Auth::user()->id)->where('product_id', $detailedProduct->id)->first() == null)
                    ...
                    <div data-auth="{{ auth()->check() }}" data-user="{{ auth()->user() }}"
                        data-details="{{ $detailedProduct }}" id="related_products">
