            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="row ">
                        ...
                        <div class="col done">
                            <div class="text-center text-success">
                                <a href="{{ route('checkout.store_shipping_info') }}" class="text-success">
                        ...
                        <div class="col active">
                            <div class="text-center text-primary">
                                ...
                                <h3 class="fs-14 fw-600 d-none d-lg-block text-capitalize">{{ translate('4. Payment') }}
                                </h3>
                            </div>
                        </div>
                        {{-- <div class="col">
    ...
    <section class="mb-4">
        <div class="container text-left">
            <div class="row">
                <div class="col-lg-8">
                    <form
                        action="{{ URL::temporarySignedRoute('payment.checkout', now()->addMinutes(30), ['user' => auth()->user()->id]) }}"
                        class="form-default" role="form" method="POST" id="checkout-form">
                        @csrf
                                    ...
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        ...
                                        @endif --}}
                                            ...
                                            @if (\App\BusinessSetting::where('type', 'fawry_sandbox')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="fawry" class="online_payment" type="radio"
                                                            name="payment_option" checked />
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            <img src="{{ static_asset('assets/img/cards/fawry.png') }}"
                                                                class="img-fluid mb-2">
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-600 fs-15">{{ translate('Fawry') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                            ...
                                            @if (\App\BusinessSetting::where('type', 'TapPayment_sandbox')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="tappayment" class="online_payment" type="radio"
                                                            name="payment_option" checked />
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            <img src="{{ static_asset('assets/img/cards/tappayment.png') }}"
                                                                class="img-fluid mb-2">
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-600 fs-15">{{ translate('TapPayment') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                            ...
                                            @if (\App\BusinessSetting::where('type', 'paytab_sandbox')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input
                                                            value='paytab{{ get_setting('pay_tab_defualt') == 'sa' ? 'saudi' : 'egypt' }}'
                                                            class="online_payment" type="radio" name="payment_option"
                                                            checked />
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            <img src="{{ static_asset('assets/img/cards/Paytabs.jpeg') }}"
                                                                class="img-fluid mb-2">
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-600 fs-15">{{ translate('PayTabs') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                            ...
                                            @if (\App\BusinessSetting::where('type', 'fekra_pay_sandbox')->first()->value == 1)
                                                <input id="pay_method" name="pay_method" type="hidden" />

                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input id="fekra_pay" value="fekra_pay" class="online_payment"
                                                            type="radio" name="payment_option" checked />
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            <img src="{{ static_asset('assets/img/cards/fekra_pay.png') }}"
                                                                class="img-fluid mb-2">
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-600 fs-15">{{ translate('Fekra Payment') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                            ...
                                            @if (\App\BusinessSetting::where('type', 'cash_payment')->first()->value == 1)
                                                {{-- @php
                                                    ...
                                                    foreach (
                                                        \App\Models\Cart::where('owner_id', session()->get('owner_id'))
                                                            ->where('user_id', auth()->user()->id)
                                                            ->get()
                                                        as $cartItem
                                                    ) {
                                                        if ($cartItem->product['digital'] == 1) {
                                                            $digital = 1;
                                                        }
                                                        if ($cartItem->product['cash_on_delivery'] == 0) {
                                                            $cod_on = 0;
                                                        }
                                                    }
                                                @endphp --}}
                                                @if (\App\Product::find($products[0]->product_id)->digital != 1)
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                        ...
                        <div class="row align-items-center pt-3">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" id="submit_btn" onclick="submitOrder(this)"
...
@section('modal')
    <div id="select_fekra_modal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
        aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ translate('Select Pay') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div id="modal_content_fekra" class="modal-body ">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn_fekra_select_pay"
                        class="btn btn-primary">{{ translate('continue') }}</button>
                    <button type="button" class="btn btn-secondary"
...
@section('script')
    <script type="module">
        import {
            checkout
        } from "{{ env('APP_URL') }}/public/assets/js/fawry.js";

        document.getElementById("submit_btn").addEventListener("click", function() {

            let payment_option_value = document.querySelector("input[name='payment_option']:checked").value;

            if (payment_option_value == "fawry") {

                checkout(
                    "{{ get_setting('fawry_merchant_code') }}",
                    "{{ md5(rand(1, 6)) }}",
                    "{{ md5(rand(1, 6)) }}",
                    "{{ convert_price_code($total, 'EGP') }}",
                    "{{ get_setting('fawry_security_key') }}",
                    "{{ route('fawryCallback', ['payment_type' => 'cart_payment', 'user_id' => $user->id]) }}",
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#fekra_pay").change(function(e) {
                e.preventDefault();
                $("#select_fekra_modal").modal();
                console.log("checked");
                $.ajax({
                    url: "{{ route('checkout.select_pay_fekra') }}",
                    success: function(res) {
                        console.log({
                            res
                        });
                        $("#modal_content_fekra").html(res.view);
            ...
            $(document).on("change", ".fekra_payment", function() {
                $("#pay_method").val($(this).val());
            })
            $("#btn_fekra_select_pay").click(function(e) {
                e.preventDefault();
                if ($("#pay_method").val() != "") {
                    $('#checkout-form').submit();
                } else {
                    AIZ.plugins.notify('danger', '{{ translate('please select payment') }}');
                }
        ...
        function submitOrder(el) {
            ...
            if ($('#agree_checkbox').is(":checked")) {
                ...
                if ($('input[name="payment_option"]:checked').val() == "fawry") {
