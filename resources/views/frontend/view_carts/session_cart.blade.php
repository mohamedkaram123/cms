                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        @php
                                            $total = 0;
                                        @endphp
                                        @foreach (Session::get('cart')->where('owner_id', 1) as $key => $cartItem)
                                            @php
                                                ...
                                                <div class="row gutters-5">
                                                    <div class="col-lg col-2 order-1 order-lg-0 my-3 my-lg-0">
                                                        <div class="form-check">
                                                            <input data-product_id="{{ $cartItem['id'] }}"
                                                                data-owner_id="{{ 1 }}"
                                                                data-digital="{{ $product->digital }}"
                                                                data-variant="{{ !empty($cartItem['variant']) ? $cartItem['variant'] : 'variant' }}"
                                                                class="form-check-input check_product" type="checkbox"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 text-center text-md-right">
                                        @if (Auth::check())
                                            <a href="{{ route('checkout.choose_products') }}"
                                                class="btn btn-primary fw-600">{{ translate('Continue to Shipping') }}</a>
                                        @else
                                            <button id="session_btn" class="btn btn-primary fw-600"
