        ...
        <div style="background-color:{{ $flash_deal->background_color }}">
            <section class="text-center mb-5">
                <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                    ...
                    class="img-fit w-100 lazyload" style="width: 100%;height: 400px;">
            </section>
            <section class="mb-4">
                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <div class="position-relative">
                                            <a href="{{ route('product', $product->slug) }}" class="d-block">
                                                <img class="img-fit lazyload mx-auto h-160px h-sm-200px h-md-220px h-xl-270px"
                                            ...
                                            <div class="fs-15">
                                                @if (home_base_price($product->id) != home_discounted_base_price($product->id))
                                                    <del class="fw-600 opacity-50 mr-1"
                                                        style="{{ get_setting('style_price_del') }}">{{ home_base_price($product->id) }}</del>
                                                @endif
                                                <span style="{{ get_setting('style_price') }}"
