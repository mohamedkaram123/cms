<div class="aiz-category-menu{{Route::currentRouteName() != 'home'?"2":null}} bg-white rounded @if(Route::currentRouteName() == 'home') shadow-sm" @else shadow-lg" id="category-sidebar" @endif>
        ...
        @foreach (\App\Category::where('level', 0)->orderBy('order_level', 'desc')->get()->take(11) as $key => $category)
            <li class="category-nav-element" data-id="{{ $category->id }}">
                ...
                @if(count(\App\Utility\CategoryUtility::get_immediate_children_ids($category->id))>0)
                    <div class="sub-cat-menu{{Route::currentRouteName() != 'home'?"2":null}} c-scrollbar-light rounded shadow-lg p-4" style="z-index: 5" >
