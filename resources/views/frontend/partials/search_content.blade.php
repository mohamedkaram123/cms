                            ...
                            <div class="flex-grow-1 overflow--hidden minw-0">
                                ...
                                <div class="">
                                    @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                                        <del class="opacity-60 fs-15" style="{{ get_setting("style_price_del") }}">{{ home_base_price($product->id) }}</del>
                                    @endif
                                    <span style="{{ get_setting("style_price") }}" class="fw-600 fs-16 text-primary">{{ home_discounted_base_price($product->id) }}</span>
                                </div>
                            </div>
                        </div>
                    </a>
