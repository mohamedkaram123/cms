...
@section('meta_title'){{ $detailedProduct->getTranslation('name') }}@stop
                        ...
                        <div class="text-left">
                            ...
                            @if (home_price($detailedProduct->id) != home_discounted_price($detailedProduct->id))
                                ...
                                <div class="row no-gutters mt-2">
                                    ...
                                    <div class="col-10">
                                        <div class="">
                                            <strong style="{{ get_setting('style_price') }}"
                                                class="h2 fw-600 text-primary">
                                            ...
                                            <div class="col-7">
                                                ...
                                                <div class="mt-2">
                                                    <span class="fs-17 fw-600 text-primary"
                                                        style="{{ get_setting('style_price') }}">{{ home_discounted_base_price($top_product->id) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                                ...
                                                <div class="fs-15">
                                                    @if (home_base_price($related_product->id) != home_discounted_base_price($related_product->id))
                                                        <del class="fw-600 opacity-50 mr-1"
                                                            style="{{ get_setting('style_price_del') }}">{{ home_base_price($related_product->id) }}</del>
                                                    @endif
                                                    <span class="fw-700 text-primary"
                                                        style="{{ get_setting('style_price') }}">{{ home_discounted_base_price($related_product->id) }}</span>
                                                </div>
                                                <div class="rating rating-sm mt-1">
