                ...
                <form class="form-default" action="{{ route('checkout.shipping_info') }}" role="form" method="POST">
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                                ...
                                <li class="list-group-item">
                                            <div class="d-flex flex-row">
                                                <div class="form-check">
                                                    <input data-product_id="{{ $cartItem }}" data-owner_id="{{ 1 }}" class="form-check-input check_product" type="checkbox" value="" id="flexCheckChecked">
                                                </div>
                                                <span class="mr-2">
                                                    <img
                        ...
                        <div class="card-footer " style="display: flex;justify-content: space-between">
                                         <button id="choose_all" class="btn btn-outline-primary">{{ translate('Choose All')}}</a>

                                    <button type="submit" name="products" id="products_btn" class="btn fw-600 btn-primary">{{ translate('Continue to Shipping')}}</a>
