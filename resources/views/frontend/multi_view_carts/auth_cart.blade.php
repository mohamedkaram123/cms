        ...
        <div class="row cols-xs-space cols-sm-space cols-md-space">
            ...
            <div class="col-xxl-8 col-xl-10 mx-auto text-left">
                ...
                <form class="form-default" action="{{ route('checkout.shipping_info') }}" role="form" method="POST">
                  ...
                  @foreach ($owners_ids as  $owner_id)
                    <div class="card mb-3 shadow-sm border-0 rounded">
                         <div class="card-header p-3">
                               ...
                               @csrf
                                <div class="card-body">
                                                  @foreach (auth()->user()->carts->where("owner_id",$owner_id) as $key => $cartItem)
                                                        ...
                                                        <div class="row gutters-5">
                                                          <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
                                                            <div class="form-check">
                                                                <input data-product_id="{{ $cartItem["product_id"] }}" data-owner_id="{{ $owner_id }}" class="form-check-input check_product" type="checkbox" value="" id="flexCheckChecked">
                                                            </div>
                                                          </div>
