        @if (count($order_refund) > 0)
            ...
            <div class="card-body">
                <table class="table aiz-table mb-0">
                    ...
                    <tbody>
                        @foreach ($order_refund as $key => $order)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @if ($delivery_status != "refund" && $delivery_status != "delivered" && $delivery_status != "cancelled"  )
                                            <button onclick="update_dliever({{$order->id}})" class="btn btn-soft-danger btn-icon btn-circle btn-sm update_delivery_status" data-order_id="{{$order->id}}" title="{{ translate('Cancel Order') }}">
