...
<form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="name"
                                placeholder="{{translate('Product Name')}}" value="{{$product->getTranslation('name',request("lang"))}}"
                                required>
                        </div>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select name="choice_attributes[]" data-live-search="true" data-selected-text-format="count"
                        id="choice_attributes" class="form-control aiz-selectpicker attr_choice" multiple
    ...
    <div class="card">
     ...
     <div class="d-flex flex-row"  style="justify-content: space-between;width: 100%;">
            ...
            <span  class='badge badge-primary' style='width:auto;'> {{ translate("Tax not included") }}</span>
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input id="unit_price" type="text" placeholder="{{translate('Unit price')}}" name="unit_price" class="form-control"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input id="purchase_price" type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Purchase price')}}"
     ...
     @foreach(\App\Tax::where('tax_status', 1)->get() as $tax)
                ...
                $tax_amount = $product->taxe->tax;
                $tax_type =$product->taxe->tax_type;
