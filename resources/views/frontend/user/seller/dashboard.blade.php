    ...
    {{-- <div class="row gutters-10">
        <div class="col-md-3">
            <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
              <div class="px-3 pt-3">
                <div class="h3 fw-700">
                  {{ count($products_count) != 0?$products_count[0]->products_count:0  }}
                </div>
        ...
        <div class="col-md-3">
            <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    <div class="h3 fw-700">
                      {{ count($order_details_count) != 0?$order_details_count[0]->order_details_count:0 }}
                    </div>
        ...
        <div class="col-md-3">
            <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    ...
                    <div class="h3 fw-700">{{count($order_details_total) != 0?single_price($order_details_total[0]->total): single_price(0) }}</div>
