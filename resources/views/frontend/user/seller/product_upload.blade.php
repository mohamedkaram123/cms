            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control aiz-selectpicker attr_choice" data-live-search="true" name="colors[]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select name="choice_attributes[]" id="choice_attributes"
                                class="form-control aiz-selectpicker attr_choice" data-live-search="true"
