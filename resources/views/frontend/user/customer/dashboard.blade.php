    ...
    <div class="row gutters-10">
		<div class="col-md-4">
			<div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
				<div class="px-3 pt-3">
                    @if(Session::has('cart'))
                        <div class="h3 fw-700">{{ count(Session::get('cart'))}} {{ translate('Products') }}</div>
                    @else
		...
		<div class="col-md-4">
			<div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
				<div class="px-3 pt-3">
                    ...
                    @endphp
  					<div class="h3 fw-700">{{ count(Auth::user()->wishlists)}} {{ translate('Products') }}</div>
		...
		<div class="col-md-4">
			<div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
				<div class="px-3 pt-3">
                    ...
                    @endphp
					<div class="h3 fw-700">{{ $total }} {{ translate('Products') }}</div>
