<!-- Modal -->
<div  class="modal  fade" id="modal_search_product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="py-1 px-4 ">
                <div class="row clearfix mt-3">
                    ...
                    <div class="form-group col-6">
                        <input id="name" name="name" class="form-control" type="text" placeholder="{{ translate("Product Name") }}" />
                   </div>
       ...
       <div id="product_list" >
           ...
           @include("backend.marketing.coupons.product_list",[
               "coupon"=>$coupon
           ])
