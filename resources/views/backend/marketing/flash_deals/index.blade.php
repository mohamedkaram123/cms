...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('flash_deals.create',hash_role(322)) }}" class="btn btn-circle btn-info">
            ...
            <tbody>
                @foreach($flash_deals as $key => $flash_deal)
                    <tr>
						...
						<td class="text-right">
                             @if(Roles::Check("323"))
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('flash_deals.edit', ['id'=>$flash_deal->id, 'lang'=>env('DEFAULT_LANGUAGE'),"role_id"=>encrypt(323)] )}}" title="{{ translate('Edit') }}">
