                ...
                <tbody>
                    @foreach ($categories as $key => $category)
                        <tr>
                            ...
                            <td>
                                @foreach (\App\MyClasses\Attributes::get_attrs($category->id) as $attr)
                                    <p>{{ $attr->getTranslation('name') }}</p>
                                @endforeach
                            </td>
                            <td>
                            ...
                            @php
                                $cat_class = \App\MyClasses\Cat::class;
                            @endphp
                            <td class="text-right">
                                ...
                                @if (!$cat_class::check_cat_children($category->id) && !$cat_class::check_cat_products($category->id))
