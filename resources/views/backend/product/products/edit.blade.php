                            ...
                            <div id="choice_arr_value" class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select name="choice_attributes[]" id="choice_attributes"
                                        ...
                                        class="form-control aiz-selectpicker attr_choice" multiple
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input id="unit_price" type="text" placeholder="{{ translate('Unit price') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input id="purchase_price" type="number" lang="en" min="0" step="0.01"
                            ...
                            <div class="form-group row" id="quantity">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" lang="en" value="{{ $product->current_stock }}" min="1" step="1"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="tax_id" type="hidden" value="{{ $product->taxe->tax_id }}"
                                        name="tax_id[]">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input @if ($product->refurbished == 1) checked @endif id="check_refurbished"
                                            name="refurbished" type="checkbox" value="1">
                                        <span></span>
                                    </label>
                                </div>
                            </div>

                            <div id="choose_refurbished"
                                class="form-group  @if ($product->refurbished == 0) d-none @endif row ">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control " id="refurboshed_degree" name="refurbished_degree">
                                        ...
                                        @foreach (\App\Models\RefurbishedDegree::get() as $degree)
                                            <option @if (!empty($product->refurbished_product) && $degree->id == $product->refurbished_product->refurbished_degree_id) selected @endif
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input @if ($product->force_file == 1) checked @endif id="force_file"
                                            name="force_file" type="checkbox" value="1">
                                        <span></span>
                                    </label>
                                </div>
                            </div>
