...
@section('content')
    ...
    <div class="">
        <form class="form form-horizontal mar-top form-product" action="{{ route('products.store') }}" method="POST"
            ...
            <div class="row gutters-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Tags') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input id="tags" type="text" class="form-control aiz-tag-input" name="tags[]"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-size="90000" data-toggle="aizuploader"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker attr_choice" data-live-search="true"
                                ...
                                <div class="col-md-1">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input id="color_active" value="1" type="checkbox" name="colors_active">
                                        <span></span>
                                    </label>
                                </div>
                            </div>

                            <div id="choice_arr_value" class="form-group row">
                                <div class="col-md-3">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">{{ translate('Refurbished') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-md-4 col-from-label">{{ translate('Refurbished') }}</label>
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input id="check_refurbished" name="refurbished" type="checkbox" value="1">
                                        <span></span>
                                    </label>
                                </div>
                            </div>

                            <div id="choose_refurbished" class="form-group row d-none">
                                <label class="col-md-4 col-from-label">{{ translate('Refurbished Degree') }}</label>
                                <div class="col-md-8">
                                    <select class="form-control " id="refurboshed_degree" name="refurbished_degree">
                                        <option value="">{{ translate('Choose Refurbished') }}</option>
                                        @foreach (\App\Models\RefurbishedDegree::get() as $degree)
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">{{ translate('Force Files') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-md-4 col-from-label">{{ translate('Force Files') }}</label>
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input id="force_file" name="force_file" type="checkbox" value="1">
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        {{-- <div class="btn-group mr-2" role="group" aria-label="First group">
                            <button type="button" name="button" value="draft"
                                class="save_data btn btn-warning">{{ translate('Save As Draft') }}</button>
                        </div> --}}
                        <input type="hidden" value="publish" id="conent_btn" name="button" />
                        <div class="btn-group mr-2" role="group" aria-label="Third group">
                            <button type="button" value="unpublish"
                                class="save_data btn btn-primary">{{ translate('Save & Unpublish') }}</button>
                        </div>
                        <div class="btn-group" role="group" aria-label="Second group">
                            <button type="button" value="publish"
                                class="save_data btn btn-success">{{ translate('Save & Publish') }}</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    <script type="text/javascript">
        $("#check_refurbished").change(function(e) {
            if (e.target.checked) {
                $("#choose_refurbished").removeClass("d-none")
                $("#refurboshed_degree").attr("required", true)

            } else {
                $("#choose_refurbished").addClass("d-none")
                $("#refurboshed_degree").removeAttr("required")
        ...
        function check_required_inputs() {
            var checked = false;
            $('input[required]:visible').each(function(item) {
                if ($(this).val() == "") {
        ...
        $(".save_data").click(function(e) {
            ...
            if (!check_required_inputs()) {
                ...
                check_required_inputs().addClass("is-invalid")
                AIZ.plugins.notify('danger',
                    '{{ translate('Please Enter Data Require') }}');
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#customer_choice_options').append(
                        ...
                        data.text + '" class="form-control aiz-tag-input" name="choice_options_' +
                        i +
        ...
        function get_attrs(category_id) {
            $.ajax({
                type: "GET",
                url: 'get_from_category_attrs/' + category_id,
                success: function(data) {
                    console.log({
                        data
                    });
        ...
        $("#purchase_price").keyup(function(e) {
            ...
            if (parseInt($(this).val()) > parseInt($("#unit_price").val())) {
