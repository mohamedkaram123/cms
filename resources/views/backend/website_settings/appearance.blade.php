            ...
            <div class="card">
    			...
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
    			<div class="card-header">
    				<h6 class="fw-600 mb-0">{{ translate('Custom Script Admin') }}</h6>
    			</div>
    			<div class="card-body" >
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					@csrf
    					<div class="form-group row">
    						<label class="col-md-3 col-from-label">{{ translate('Header custom script - before </head>') }}</label>
                            <div class="col-md-8">
        						<input type="hidden" name="types[]" value="header_script_admin">
        						<textarea style="background:#333;color:#fff;direction:ltr" name="header_script_admin" rows="10" class="form-control" placeholder="<script>&#10;...&#10;</script>">{{ get_setting('header_script_admin') }}</textarea>
                                <small>{{ translate('Write script admin with <script> tag') }}</small>
                            </div>
    					</div>
    					@csrf
    					<div class="form-group row">
    						<label class="col-md-3 col-from-label">{{ translate('Footer custom script - before </body>') }}</label>
                            <div class="col-md-8">
        						<input type="hidden" name="types[]" value="footer_script_admin">
        						<textarea style="background:#333;color:#fff;direction:ltr" name="footer_script_admin" rows="10" class="form-control" placeholder="<script>&#10;...&#10;</script>">{{ get_setting('footer_script_admin') }}</textarea>
                                <small>{{ translate('Write script with <script> tag') }}</small>
                            </div>
    					</div>
    					<div class="text-right">
