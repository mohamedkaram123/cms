				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-banner3-target">
                            ...
                            <input type="hidden" name="types[]" value="home_banner3_header_imgs">
							<input type="hidden" name="types[]" value="home_banner3_txt_link">
								...
								@foreach (json_decode(get_setting('home_banner3_images'), true) as $key => $value)
									<div class="row gutters-5">
                                         <div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner3_header_imgs">
												<input type="text" class="form-control" placeholder="title banner" name="home_banner3_header_imgs[]" value="{{ json_decode(get_setting('home_banner3_header_imgs'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-5">
											<div class="form-group">
                                         ...
                                         <div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner3_txt_link">
												<input type="text" class="form-control" placeholder="txext link banner" name="home_banner3_txt_link[]" value="{{ json_decode(get_setting('home_banner3_txt_link'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md">
											<div class="form-group">
                                        ...
                                        <div class="col-md-auto">
											<div class="form-group">
												<a type="button" href="{{route("genenral_trans.index",[
						...
						<button
							...
							<div class="row gutters-5">
                                  <div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner3_header_imgs">
												<input type="text" class="form-control" placeholder="title banner" name="home_banner3_header_imgs[]" >
											</div>
										</div>
								<div class="col-md-5">
									<div class="form-group">
										...
										<div class="file-preview box sm">
                                         ...
                                         <div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner3_txt_link">
												<input type="text" class="form-control" placeholder="text link banner" name="home_banner3_txt_link[]" >
											</div>
										</div>
								<div class="col-md">
									<div class="form-group">
