...
@section('content')
        ...
        <div class="card-body">
            <div class="row gutters-10">
                        ...
                        <div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Widget title" name="widget_two"
                                        value="{{ get_setting('widget_two') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ translate('Links') }}</label>
                                    <div class="w3-links-target">
                                            ...
                                            @foreach (json_decode(App\BusinessSetting::where('type', 'widget_two_labels')->first()->value, true) as $key => $value)
                                                <div class="row gutters-5">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="http://"
                                                                name="widget_two_links[]"
                                                                value="{{ json_decode(App\BusinessSetting::where('type', 'widget_two_links')->first()->value, true)[$key] }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <button type="button"
                ...
                <div class="col-lg-12">
                    <div class="card shadow-none bg-light">
                        <div class="card-header">
                            <h6 class="mb-0">{{ translate('Link Widget Threee') }}</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Widget title"
                                        name="widget_three" value="{{ get_setting('widget_three') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ translate('Links') }}</label>
                                    <div class="w3-links-target">
            ...
            <div class="card-body">
                ...
                <div class="card shadow-none bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>{{ translate('App Links') }}</label>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="lab la-apple"></i></span>
                                </div>
                                <input type="hidden" name="types[]" value="app_store_link">
                                <input type="text" class="form-control" placeholder="http:// app store"
                                    name="app_store_link" value="{{ get_setting('app_store_link') }}">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="lab la-google-play"></i></span>
                                </div>
                                <input type="hidden" name="types[]" value="google_play_link">
                                <input type="text" class="form-control" placeholder="http:// google play"
                                    name="google_play_link" value="{{ get_setting('google_play_link') }}">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="las la-shopping-bag"></i></span>
                                </div>
                                <input type="hidden" name="types[]" value="app_gallary_link">
                                <input type="text" class="form-control" placeholder="http:// gallary app"
                                    name="app_gallary_link" value="{{ get_setting('app_gallary_link') }}">
                            </div>
    ...
    <div class="card shadow">
        <div class="card-header">
            <h6 class="mb-0">{{ translate('Footer setting Links ') }}</h6>
        </div>
        <div class="card-body">
            @php
            ...
            @endphp
            <form action="{{ route('business.footer') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="types[]" value="footer_links_descriptions">
                <div class="form-group">

                    <div class="input-group form-group">
                        <input type="hidden" name="types[]" value="footer_links_descriptions">
                        <input type="hidden" name="types[]" value="footer_links_title">
                        <input class="form-control  ml-4 col-md-3 col-12" type="text"
                            value="{{ $link_footer_title[0] }}" name="footer_links_title[]" />
                        <textarea name="footer_links_descriptions[]" class="form-control col-md-7 col-12"
                            rows="3">{{ $link_footer_des[0] }}</textarea>
                    </div>
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="hidden" name="types[]" value="footer_links_title">
                        <input class="form-control  ml-4 col-md-3 col-12" type="text"
                            value="{{ $link_footer_title[1] }}" name="footer_links_title[]" />
                        <textarea name="footer_links_descriptions[]" class="form-control col-md-7 col-12"
                            rows="3">{{ $link_footer_des[1] }}</textarea>
                    </div>
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="hidden" name="types[]" value="footer_links_title">
                        <input class="form-control  ml-4 col-md-3 col-12" type="text"
                            value="{{ $link_footer_title[2] }}" name="footer_links_title[]" />
                        <textarea name="footer_links_descriptions[]" class="form-control col-md-7 col-12"
                            rows="3">{{ $link_footer_des[2] }}</textarea>
                    </div>

                    <div class="input-group form-group">
                        <input type="hidden" name="types[]" value="footer_links_descriptions">
                        <input type="hidden" name="types[]" value="footer_links_title">
                        <input class="form-control ml-4 col-md-3 col-12" type="text" value="{{ $link_footer_title[3] }}"
                            name="footer_links_title[]" />
                        <textarea name="footer_links_descriptions[]" class="form-control col-md-7 col-12"
                            rows="5">{{ $link_footer_des[3] }}</textarea>
                    </div>
                </div>
                <div class="text-right">
                    <button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
