                ...
                @foreach ($orders as $key => $order_id)
                    ...
                    @if($order != null)
                        <tr>
                            ...
                            <td class="text-right">
                                @if(Roles::Check(27))
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('inhouse_orders.show', ["id"=>encrypt($order->id),"role_id"=>encrypt(27)])}}" title="{{ translate('View') }}">
                                    <i class="las la-eye"></i>
                                </a>
                                @endif
                                @if(Roles::Check(28))
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('invoice.download', ["order_id"=>encrypt($order->id),"role_id"=>encrypt(28)]) }}" title="{{ translate('Download Invoice') }}">
