        ...
        <table class="table aiz-table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $tax->name }}</td>
                    <td>{{ $tax->tax }}</td>
                    <td>{{ $tax->tax_type == "percent"?translate("Percent"):translate("Fixed") }}</td>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" placeholder="{{translate('Tax Rate')}}" id="tax" name="tax" class="form-control" required>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <option value="amount">{{ translate("Fixed")}}</option>
                                </select>
                                </div>
