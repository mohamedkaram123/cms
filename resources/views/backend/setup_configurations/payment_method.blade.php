    ...
    <div class="row">
        <div class="col-md-6" id="pay_tabs">
            {{-- <div class="card" >
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYTAB_PROFILE_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Profile Id')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYTAB_PROFILE_ID" value="{{  get_setting('PAYTAB_PROFILE_ID') }}" placeholder="{{ translate('Profile Id') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYTAB_SERVER_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Server Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYTAB_SERVER_KEY" value="{{  get_setting('PAYTAB_SERVER_KEY') }}" placeholder="{{ translate('Server Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">

                        <div class="col-md-4">
                            <label class="col-from-label">{{translate('PayTab Sandbox Mode')}}</label>
                        </div>

                        <div class="col-md-8">

                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input value="1" name="paytab_sandbox" type="checkbox" @if (\App\BusinessSetting::where('type', 'paytab_sandbox')->first()->value == 1)
                                    checked
                                @endif>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('TapPayment Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        <input type="hidden" name="payment_method" value="paytab">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="TapPayment_Secret_Key">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('TapPayment Secret API Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="TapPayment_Secret_Key" value="{{  get_setting('TapPayment_Secret_Key') }}" placeholder="{{ translate('TapPayment Secret API Key') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="TapPayment_Publishable_Key">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('TapPayment Publishable API Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="TapPayment_Publishable_Key" value="{{  get_setting('TapPayment_Publishable_Key') }}" placeholder="{{ translate('TapPayment Publishable API Key') }}" required>
                            </div>
                        </div>


                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="TapPayment_MERCHANT_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('TapPayment Merchant ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="TapPayment_MERCHANT_KEY" value="{{  get_setting('TapPayment_MERCHANT_KEY') }}" placeholder="{{ translate('TapPayment Merchant ID') }}" >
                            </div>
                        </div>
                        <div class="form-group row">

                        <div class="col-md-4">
                            <label class="col-from-label">{{translate('TapPayment Sandbox Mode')}}</label>
                        </div>

                        <div class="col-md-8">

                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input value="1" name="TapPayment_sandbox" type="checkbox" @if (\App\BusinessSetting::where('type', 'TapPayment_sandbox')->first()->value == 1)
                                    checked
                                @endif>
                                <span class="slider round"></span>
                            </label>
        ...
        <div class="col-md-6" id="fawry_payment">

        </div>

        <div class="col-md-6" id="fekra_payment">
