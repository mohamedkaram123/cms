                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <select name="mail_driver" class="form-control">
                                <option value="smtp">{{ translate("Smtp") }}</option>
                                <option value="mailchimp">{{ translate("Mailchimp") }}</option>
                                <option value="mailgun">{{ translate("Mailgun") }}</option>
