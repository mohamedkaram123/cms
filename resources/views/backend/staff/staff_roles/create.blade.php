                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-md-2">
                                                <label class="aiz-switch aiz-switch-success mb-0">
                                                    <input id="main_group_{{ $role['group_role'] }}"
                                                        data-id="{{ $role['group_role'] }}" class="main_group"
                                                        type="checkbox" name="permissions[]" class="form-control demo-sw"
                                                        value="{{ $role['group_role'] }}">
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="card_body_{{ $role['group_role'] }}" class="card-body d-none">
                                                ...
                                                <div class="col-md-2">
                                                    <label class="aiz-switch aiz-switch-success mb-0">
                                                        <input type="checkbox" name="permissions[]"
                                                            class="form-control demo-sw branch_checke_role_{{ $role['group_role'] }}"
                                                            value="{{ $item['role'] }}">
                                                        <span class="slider round"></span>
                                                    </label>
                                                </div>
