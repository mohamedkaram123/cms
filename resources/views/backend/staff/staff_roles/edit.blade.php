                    ...
                    <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row w-100">
                                        <div class="col-md-10">
                                            <label class="col-from-label">{{ $role["group_title"] }}</label>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input id="main_group_{{$role["group_role"]}}" data-id="{{$role["group_role"] }}" @php if(in_array($role["group_role"], $permissions)) echo "checked"; @endphp class="main_group" type="checkbox" name="permissions[]" class="form-control demo-sw" value="{{ $role["group_role"] }}">
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div id="card_body_{{$role["group_role"]}}" class="card-body @php if(!in_array($role["group_role"], $permissions))echo "d-none"; @endphp ">
                                  @foreach ($role["group_roles"] as $item)
                                    <div class="row w-100">
                                        <div class="col-md-10">
                                            <label class="col-from-label">{{ $item["title"] }}</label>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input type="checkbox" name="permissions[]" class="form-control demo-sw branch_checke_role_{{$role["group_role"]}}" @php if(in_array($item["role"], $permissions)) echo "checked"; @endphp value="{{ $item["role"] }}">
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
...
$(".main_group").change(function (e) {
    ...
    if(checked){
                        $("#card_body_"+id).removeClass("d-none");

        // $(".branch_checke_role_"+id).prop('checked', true);
    }else{
                $("#card_body_"+id).addClass("d-none");

        $(".branch_checke_role_"+id).prop('checked', false);
