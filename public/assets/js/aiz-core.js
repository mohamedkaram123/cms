...
(function($) {
    ...
    AIZ.uploader = {
        ...
        uploadSelect: function() {
            ...
            $(".aiz-uploader-select").each(function() {
                ...
                elem.on("click", function(e) {
                    let allFielsData = AIZ.uploader.data.allFiles;
                    ...
                    let size = valueObject.file_size;

                    if (AIZ.uploader.data.limit_size != null &&
                        AIZ.uploader.data.limit_size != undefined &&
                        AIZ.uploader.data.limit_size != "") {
                        if (AIZ.uploader.data.limit_size <= size) {
                            return AIZ.plugins.notify('danger', 'file size not suitable');
                        }
                    }
        ...
        trigger: function(
            ...
            var elem = $(elem);
            AIZ.uploader.data.limit_size = elem.data("size") == undefined ? null : elem.data("size");
    ...
    AIZ.plugins = {
                ...
                $(".aiz-count-down").each(function() {
                    ...
                    $this.countdown(date).on("update.countdown", function(event) {
                        var $this = $(this).html(
                            event.strftime(
                                "" +
                                '<div class="countdown-item"><span class="countdown-digit">%-D Day</span></div><span class="countdown-separator">:</span>' +
                                '<div class="countdown-item"><span class="countdown-digit">%H Hour</span></div><span class="countdown-separator">:</span>' +
                                '<div class="countdown-item"><span class="countdown-digit">%M Minute</span></div><span class="countdown-separator">:</span>' +
                                '<div class="countdown-item"><span class="countdown-digit">%S Second</span></div>'
                            )
                        );
                    });
        ...
        slickCarousel: function() {
            $(".aiz-carousel").not(".slick-initialized").each(function() {
                ...
                var slidesMobArrows = $this.data("mob_arrows");
                var slidesMobDots = $this.data("mob_dots");


                if ($this.data("mob") == "active") {
                    if ($(window).width() < 700) {

                        slidesArrows = slidesMobArrows
                        slidesDots = slidesMobDots
                    }
            ...
            if ($(".aiz-range-slider")[0]) {
                $(".aiz-range-slider").each(function() {
                    ...
                    noUiSlider.create(c, {
                            ...
                            connect: !0,
                            direction: c.getAttribute("data-dir"),
                            range: {
            ...
            $('.aiz-share').jsSocials({
                ...
                shares: [{
                    ...
                    },
                    {
                        ...
                        shareUrl: `https://api.whatsapp.com/send?text=${location.href}`,


                    },
                    {
                        share: "telegram",
                        logo: "lab la-telegram-plane"
                    },
                    {
                        share: "stumbleupon",
                        logo: "las la-copy",
                        shareUrl: "javascript:(function() {  navigator.clipboard.writeText('" + window.location.href + "'); AIZ.plugins.notify('success', 'the link is copied'); })()",
                        countUrl: "",
                        shareIn: "self"
                    }
                ]
