...
// use App\MyClasses\Facdes\AuthFacade;
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('featured_categories', "api\HomeController@featured_categories");
    Route::get('home_banners1', "api\HomeController@home_banners1");
    Route::get('home_banners2', "api\HomeController@home_banners2");
    Route::get('home_banners3', "api\HomeController@home_banners3");
    Route::get('featured_products', "api\HomeController@featured_products");
    Route::get('best_selling', "api\HomeController@best_selling");
    Route::get('last_products', "api\HomeController@last_products");
    Route::get('home_categories', "api\HomeController@home_categories");
    Route::get('top_10_categories', "api\HomeController@top_10_categories");
    Route::get('top_10_brands', "api\HomeController@top_10_brands");
    Route::get('headers', "api\HomeController@headers");
    Route::get('widgets', "api\HomeController@widgets");
    Route::get('footer_data_desc', "api\HomeController@footer_data_desc");
