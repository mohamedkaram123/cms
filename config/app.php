...
return [
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\Facades\AuthFacadeProvider::class,
        App\Providers\Facades\HomeFacadeProvider::class,
    ...
    */
    ...
    'aliases' => [
        ...
        'History' => App\MyClasses\History::class,
        'Mailchimp' => NZTim\Mailchimp\MailchimpFacade::class,
        'TempDiscount' => App\MyClasses\TempDiscount::class,
        'SpcialOffer' => App\MyClasses\SpcialOffer::class,
        'Roles' => App\MyClasses\Roles::class,
        "OrderData" => App\MyClasses\OrderData::class,
        "CartData" => App\MyClasses\CartData::class,
        'Carbon' => Illuminate\Support\Carbon::class,
        "Cat" => App\MyClasses\Cat::class,
        "BusinessSettings" => App\MyClasses\BusinessSettings::class,
        "AuthData" => App\Api\Facdes\AuthFacade::class,
        "Home" => App\Api\Facdes\HomeFcade::class,
